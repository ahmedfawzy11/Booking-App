...
class SettingsListData {
  ...
  List<SettingsListData> getCountryListFromJson(
    Map<String, dynamic> json,
  ) {
    List<SettingsListData> countryList = [];
    if (json['countryList'] != null) {
      json['countryList'].forEach((
        v,
      ) {
  ...
  static List<SettingsListData> subHelpList = [
    SettingsListData(
      titleTxt: "",
      subTxt: "You can cancel",
    ),
    SettingsListData(
      titleTxt: "",
      subTxt: "GO to Trips and choose your trip",
    ),
    SettingsListData(
      titleTxt: "",
      subTxt: "You'll be taken to",
    ),
    SettingsListData(
      titleTxt: "",
      subTxt: "If you cancel, your ",
    ),
    SettingsListData(
      titleTxt: "",
